...
import com.purewhite.ywc.frame1.databinding.ActivityAndroidStudyBinding;
import com.purewhite.ywc.frame1.ui.adapter.AndroidStudyAdapter;
    ...
    private OnItemListener onItemListener=new OnItemListener() {
        ...
        public void OnClick(RecyclerView.Adapter adapter, View view, int position, boolean itemView) {
            if (adapter instanceof AndroidStudyAdapter)
            {
                ...
                ActivitySkipUtils.startActivity(WebActivity.class, BundleUtils.buidler().put(TagUtils.web_uri,uri).build());
            }
        }
    };
